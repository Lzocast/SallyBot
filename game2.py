...
def guard():
    ...
    actions_dict = {
        ...
        "attack": (
            ...
            " trying to decide if you mean to land a killing blow \nor just knock him out with"
    ...
    # While loop
    while True:
        action = input("DM_Sally: What do you do? [attack | check | sneak | leave]? >").lower()
        if action in actions_dict.keys():
            ...
            if action == "sneak":
                ...
                you_died(
                    ...
                    " with a loud 'creeeeEEEEaak'.  \nWoken by the noise the Guard reaches for"
                    " his dagger, and as you scramble for your sword pain blossoms in your"
                    " \nchest and everything goes grey... and dark... You just died.\n<GAME OVER>"
                )
                break
            elif action == "leave":
                return blue_door_room(
                    "DM_Sally: Hmm, tough call. Let's recap: Guard in front of an iron door on the right. "
                    "Treasure chest\n to the left...\n"
                )
...
def blue_door_room(t):
    ...
    if action.lower() in ["treasure", "chest", "left"]:
        ...
        if choice == "1":
            ...
            time.sleep(3)
            print(
                "DM_Sally: The chest creaks open... the guard stirs... snorts..." 
                "and resumes his rest. That's one heavy sleeper!"
            )
            time.sleep(4)
            ...
            if treasure_choice == "1":
                ...
                time.sleep(3)
                print(
                    "\tDM_Sally: Woohoo! Bounty and a shiney new sword. You discard your current, much crapier," 
                    "sword in the chest."
                    )
...
def red_door_room(t):
    ...
    time.sleep(9)
    print(
        "DM_Sally: It stares at you through one narrowed eye for a moment.... and you could swear it seems to grin as a ravenous" 
    ...
    if "flee" in next_move:
        start_adventure(
            "\nDM_Sally: Reaching slowly behind you, you fumble for the door handle. Wincing as the hot metal sears your " 
            "palm, you back through the opening " 
            "\nand slam the door closed as soon as you are through. Heart pounding you reconsider your choices in life"
            " and decide to pretend that never happened."
        )
...
def start_adventure(t):
    ...
    door_picked = input(
        "DM_Sally: As you ease yourself up on aching muscles, brushing away bits of damp hay from your clothes, "
        "do you pick the red door or blue door?\nYour Decision [red | blue] > ")

    # Pick a door and we go to a room and something else happens
    if door_picked == "red":
        red_door_room(
            "\nDM_Sally: The door grinds open on stiffened hinges... and there you see a great red dragon. Towering and magnificent,"
            " flames tickle the edge of \nnostrils the size of your head as it breathes. Teeth as long as your arm poke out from" 
            " its maw... and as if sensing the stilling of your heart the beast" 
            " \nswivels its scaly head to regard you."
        )
    elif door_picked == "blue":
        blue_door_room(
            "\nDM_Sally: Opening the door slowly you see a room with a wooden treasure chest on the left, and a sleeping guard "
            "sat on a simple stool on the right "
        ...
        return start_adventure(
            "You've come to in bare stone room, on a pile of stinking hay. To your left is a red door, "
            "to your right a blue door"
        )
...
def main():
    ...
    start_adventure(
        "\nDM_Sally: Your mind is fuzzy and your breathing raspy as you peel open dry eyes. In the sooty torch light "
        "you can make out four barren stone walls \nand facing each other on opposite sides of the room, two doors. "
        "To your left is a red door, the air on that side of the room feels warm and sharp... "
